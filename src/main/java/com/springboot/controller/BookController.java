...
public class BookController {
	...
	public boolean lent(@RequestBody Rental rental) {
		boolean statu = bookService.checkRental(rental);
		System.out.println("test:+++++"+statu);
		// 表示未借过这本书
		if(!statu) {
			// 获取系统当前时间
	...
	@ResponseBody
	public UploadedFile uploadBookImg(@RequestParam("file") MultipartFile file) throws IllegalStateException, IOException {
